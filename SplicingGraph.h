...
public:
	...
	bool build(ReadHash& read_hash, KmerHash& left_hash, KmerHash& right_hash, int seed, vector<pair<string,float> >& transcripts);
	string forward_extend(KmerHash& kmer_hash, int seed);
	string reverse_extend(KmerHash& kmer_hash, int seed);	
	...
	bool refine_forward_by_pair(ReadHash& read_hash, KmerHash& left_hash, KmerHash& right_hash, int p);
	bool refine_reverse_by_pair(ReadHash& read_hash, KmerHash& left_hash, KmerHash& right_hash, int p);
	bool forward_extend(KmerHash& kmer_hash, string& contig, const string& stop_seq, int seed);
	bool reverse_extend(KmerHash& kmer_hash, string& contig, const string& stop_seq, int seed);
	void branch_extend_by_coverage(ReadHash& read_hash, KmerHash& left_hash, KmerHash& right_hash);
	...
	void refine_graph(ReadHash& read_hash, KmerHash& left_hash, KmerHash& right_hash);
